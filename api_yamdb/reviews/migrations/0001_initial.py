# Generated by Django 3.2.16 on 2023-05-12 12:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(code=400, message='150 characters or fewer. Letters, digits and @/./+/-/_ only', regex='^[\\w.@+-]+\\Z'), api.validators.validate_username])),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('first_name', models.CharField(blank=True, max_length=150, verbose_name='Имя')),
                ('last_name', models.CharField(blank=True, max_length=150, verbose_name='Фамилия')),
                ('bio', models.TextField(blank=True, verbose_name='Биография')),
                ('role', models.CharField(choices=[('user', 'пользователь'), ('moderator', 'модератор'), ('admin', 'администратор')], default='user', max_length=10, verbose_name='Роли')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count_review', models.IntegerField(default=0, verbose_name='Колличество ревью')),
                ('sum_score', models.IntegerField(default=0, verbose_name='Сумма оценок ревью')),
