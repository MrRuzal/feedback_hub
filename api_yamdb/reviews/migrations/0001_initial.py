# Generated by Django 3.2.16 on 2023-05-14 17:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(code=400, message='150 characters or fewer. Letters, digits and @/./+/-/_ only', regex='^[\\w.@+-]+\\Z'), reviews.validators.validate_username])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=256, verbose_name='название')),
                ('year', models.SmallIntegerField(validators=[reviews.validators.validet_year], verbose_name='Год выпуска')),
